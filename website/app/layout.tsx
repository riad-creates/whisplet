...
export const metadata: Metadata = {
  metadataBase: new URL('https://whisplet.vercel.app'),
  ...
  openGraph: { title: 'Whisplet — Think it. Say it. There it is.', description: 'Local dictation. A little less typing. A little more you.', type: 'website', url: '/' },
};
